...
### UX Designer | Nacos Marine (formerly Wärtsilä)
...
- Increased engineer productivity and scoped down long manuals by growing design systems and architecting user-centric (HCI) workflow improvements across the legacy interfaces.
...
### MSc Human-Centered Artificial Intelligence | Technical University of Denmark

*Aug 2022 – Mar 2025*

Human-centered design, accessibility, interaction design, data visualization, ML foundations. Thesis: a dashboard using data from a wearable button to improve treatment for patients with mental health disorders.
